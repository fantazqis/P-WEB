...
INSERT INTO Wisata (WisataID, Provinsi, NamaWisata, DeskripsiSingkat, PetaLokasi)
VALUES ('1', 'Jawa Barat', 'Curug Luhur', 'Curug Luhur adalah sebuah air terjun yang berada di daerah kecamatan Ciomas, Bogor. Tingginya 624 m', 'https://goo.gl/maps/omZhQ9EHXt12'),
('2', 'Jawa Barat', 'Kebun Raya Bogor', 'kebun raya bogor sebuah kebun botani besar yang terletak di Kota Bogor, Indonesia. Luasnya mencapai 87 hektaree dan memiliki 15.000 jenis koleksi pohon dan tumbuhan.', 'https://goo.gl/maps/y6jRYXaoB6B2');
('3', 'Jawa Barat', 'Puncak', 'Puncak adalah sebuah daerah wisata pegunungan yang termasuk ke dalam wilayah Kabupaten Bogor dan Kabupaten Cianjur, Provinsi Jawa Barat. Puncak terletak 70 km sebelah selatan Jakarta', 'https://goo.gl/maps/mg3Qfk5EUdT2');
('4', 'Jawa Barat', 'Taman Safari Indonesia', 'Taman Safari Indonesia adalah tempat wisata keluarga berwawasan lingkungan yang berorientasi pada habitat satwa di alam bebas. ', 'https://goo.gl/maps/ePSEW4Ex9KT2');
('5', 'Jawa Barat', 'Gunung Tangkuban Parahu', 'Gunung Tangkuban Perahu adalah salah satu gunung yang terletak di Provinsi Jawa Barat, Indonesia.', 'https://goo.gl/maps/ye5ca2ZWQbr');
('6', 'Jawa Barat', 'Kawah Putih', ' Kawah putih merupakan sebuah danau yang terbentuk dari letusan Gunung Patuha.', 'https://goo.gl/maps/vkBt6GRBC3x');
('7', 'Jawa Barat', 'Taman Wisata Mekarsari', 'Taman Wisata Mekarsari merupakan salah satu pusat pelestarian keanekaragaman hayati buah-buahan tropika terbesar di dunia', 'https://goo.gl/maps/LcA9Dzy4Ecw');
('8', 'Jawa Barat', 'Taman Wisata Matahari', 'Taman Wisata Matahari adalah tempat wisata keluarga yang berlokasi di Jalan Raya Puncak KM 77 Cilember, Cisarua, Bogor, Jawa Barat.', 'https://goo.gl/maps/92Ss2qUv1A42');
